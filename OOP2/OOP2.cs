...
namespace OOP2
{
    public partial class OOP2 : Form
    {
        ...
        private void btn_CreateObj_Click(object sender, EventArgs e)
        {
            ...
            th1 = new Thing("A tingummy: ", "A rather boring object");
            ...
            textBox1.Text = "Here this is...\r\n" +
                th1.Name + th1.Discription + "\r\n" +
                th2.Name + th2.Discription + "\r\n" +
                tr1.Name + tr1.Discription + "which is worth Gr" + tr1.Value + "\r\n" +
                tr2.Name + tr1.Discription + "which is worth Gr" + tr2.Value + "\r\n" +
                "You can see the " + r1.Name + r1.Discription + "with exits to " + r1.N + ", " + r1.E + ", " + r1.S + ", " + r1.W + "\r\n" + "and" +
                r2.Name + r2.Discription + "with exits to " + r2.N + ", " + r2.E + ", " + r2.S + ", " + r2.W;
        }
    }
}
